  ...
  return (
    <div className='page'>
      <div className='slider-container mt-2'>
        <div className='blog-sliding-container'>
          {blogSliding.map((Blog, index) => (
            <div className='border-item' key={index}>{Blog}</div>
          ))}
      ...
      <div className='blog-grid mt-2'>
        {blogs.map((item, id) => (
          <div key={id} className='blogs-container' >
            <img className='img-width-4' src={item.img} onClick={() => handleBlog(item)} />
